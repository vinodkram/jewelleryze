                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 text-right">
                                <div id="dataTable_filter" class="dataTables_filter">
                                    ...
                                    @csrf
                                    <label><input type="search" class="form-control form-control-sm" placeholder="Search By Name/SKUID" aria-controls="dataTable" name="search" value="{{ $searchTxt }}"></label>&nbsp;
                                    <button class="btn btn-primary">{{__('admin.SearchLabel')}}</button>&nbsp;
                                    <a href="{{ route('admin.product.index') }}" class="btn btn-primary">{{__('admin.ResetLabel')}}</a>
                                    </form>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach ($products as $index => $product)
                                    <tr>
                                        ...
                                        <td><a target="_blank" href="{{ $frontend_view.$product->slug }}">{{ $product->name }}</a></td>
