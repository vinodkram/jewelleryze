                      ...
                      <div class="container-fluid">
                        <form action="{{ route('admin.footer-link.store') }}" method="POST">
							...
							<div class="form-group pt-4">
                                <label for=""><b><u>Note :-</u></b> <br> General Page Link Ex. :- <b>/slug</b></label>
                                <label for="">Custom Page Link Ex. :- <b>/pages?custom=slug</b></label>
                            </div>
...
<script>
    function deleteData(id){
        $("#deleteForm").attr("action",'{{ url("footer-link/") }}'+"/"+id)
    }
</script>
@endsection
