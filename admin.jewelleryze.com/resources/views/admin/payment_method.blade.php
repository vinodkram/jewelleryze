                            ...
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-3">
                                    <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                                        ...
                                        <li class="nav-item border rounded mb-1">
                                            <a class="nav-link" id="ccavenue-tab" data-toggle="tab" href="#ccavenueTab" role="tab" aria-controls="ccavenueTab" aria-selected="true">{{__('admin.CCAvenue')}}</a>
                                        </li>
                                ...
                                <div class="col-12 col-sm-12 col-md-9">
                                    <div class="border rounded">
                                        <div class="tab-content no-padding" id="settingsContent">
                                            ...
                                            <div class="tab-pane fade" id="ccavenueTab" role="tabpanel" aria-labelledby="ccavenue-tab">
                                                <div class="card m-0">
                                                    <div class="card-body">
                                                        <form action="{{ route('admin.update-ccavenue') }}" method="POST">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.CCAvenueStatus')}}</label>
                                                                <div>
                                                                    @if ($ccavenue->status == 1)
                                                                        <input id="status_toggle" type="checkbox" checked data-toggle="toggle" data-on="{{__('admin.Enable')}}" data-off="{{__('admin.Disable')}}" data-onstyle="success" data-offstyle="danger" name="status">
                                                                        @else
                                                                        <input id="status_toggle" type="checkbox" data-toggle="toggle" data-on="{{__('admin.Enable')}}" data-off="{{__('admin.Disable')}}" data-onstyle="success" data-offstyle="danger" name="status">
                                                                    @endif
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Account Mode')}}</label>
                                                                <select name="account_mode" id="account_mode" class="form-control">
                                                                    <option {{ $ccavenue->account_mode == 'live' ? 'selected' : '' }} value="live">{{__('admin.Live')}}</option>
                                                                    <option {{ $ccavenue->account_mode == 'sandbox' ? 'selected' : '' }} value="sandbox">{{__('admin.Sandbox')}}</option>
                                                                </select>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Name')}}</label>
                                                                <input type="text" class="form-control" name="name" value="{{ $ccavenue->name }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Description')}}</label>
                                                                <input type="text" class="form-control" name="description" value="{{ $ccavenue->description }}">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="country_name" id="" class="form-control select2">
                                                                  ...
                                                                  @foreach ($countires as $country)
                                                                  <option {{ $ccavenue->country_code == $country->code ? 'selected' : '' }} value="{{ $country->code }}">{{ $country->name }}
                                                                  </option>
                                                                  @endforeach
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select name="currency_name" id="" class="form-control select2">
                                                                  ...
                                                                  @foreach ($currencies as $currency)
                                                                  <option {{ $ccavenue->currency_code == $currency->code ? 'selected' : '' }} value="{{ $currency->code }}">{{ $currency->name }}
                                                                  </option>
                                                                  @endforeach
                                                                </select>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="">{{__('admin.Currency rate')}} ( {{__('admin.Per')}} {{ $setting->currency_name }})</label>
                                                                <input type="text" class="form-control" name="currency_rate" value="{{ $ccavenue->currency_rate }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.CCAvenueMerchantId')}}</label>
                                                                <input type="text" class="form-control" name="ccavenue_merchand_id" value="{{ $ccavenue->merchand_id }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.CCAvenueKey')}}</label>
                                                                <input type="text" class="form-control" name="ccavenue_key" value="{{ $ccavenue->key }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.CCAvenueSecretKey')}}</label>
                                                                <input type="text" class="form-control" name="ccavenue_secret" value="{{ $ccavenue->secret_key }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.CCAvenueKeySandbox')}}</label>
                                                                <input type="text" class="form-control" name="ccavenue_sandbox_key" value="{{ $ccavenue->sandbox_key }}">
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="">{{__('admin.CCAvenueSecretKeySandbox')}}</label>
                                                                <input type="text" class="form-control" name="ccavenue_sandbox_secret" value="{{ $ccavenue->sandbox_secret_key }}">
                                                            </div>
