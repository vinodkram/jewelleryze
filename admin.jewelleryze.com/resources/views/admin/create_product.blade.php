                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.product.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                    <label>{{__('admin.Video Thumbnail One Preview')}}</label>
                                    <div>
                                        <img id="preview-video" class="admin-img" src="{{ asset('uploads/website-images/preview-video.png') }}" alt="">
                                    </div>

                                    <div class="form-group col-12">
                                    <label>{{__('admin.Video Thumbnail One')}} <span class="text-danger">*</span></label>
                                    <input type="file" class="form-control-file"  name="video_thumb" onchange="previewThumnailVideo(event)">
                                    </div>

                                </div>
                                <div class="form-group col-4">
                                    <label>{{__('admin.Video Thumbnail Second Preview')}}</label>
                                    <div>
                                        <img id="preview-video-sec" class="admin-img" src="{{ asset('uploads/website-images/preview-video.png') }}" alt="">
                                    </div>

                                    <div class="form-group col-12">
                                    <label>{{__('admin.Video Thumbnail Second')}} <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" id="product-video" class="form-control"  name="product_video" value="{{ old('product_video') }}">
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input type="text" id="product-video-sec" class="form-control"  name="product_video_sec" value="{{ old('product_video_sec') }}">
                                </div>
