          ...
          >
            <div className="lg:w-[642px] w-full">
              ...
              <button onClick={trackOrder} type="button">
                <div className="w-[142px] h-[50px] transition-common bg-qpurple hover:bg-qpurplelow hover:text-qpurple border border-transparent hover:border-qpurple text-white flex text-white justify-center items-center rounded">
