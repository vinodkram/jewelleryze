...
// import Accodion from "../../Helpers/MobileMenu";
import languageModel from "../../../../utils/languageModel";
import React from "react";
import Image from "next/image";
import Accodion from "../../Helpers/AccodionMobileMenu";

export default function Drawer({ className, open, action }) {
  const router = useRouter();
  const [tab, setTab] = useState("category");
  const { websiteSetup } = useSelector((state) => state.websiteSetup);
  //console.log(websiteSetup.payload.productCategories);
  ...
  //code for toggle mobile menu start
  ...
  //code for toggle mobile menu end
