      ...
      <div className="container-x block mx-auto  pt-[370px] lg:pt-[96px] relative z-20">
        ...
        <div className="lg:flex justify-between lg:mb-[80px] mb-[40px]">
          <div className="flex-1 lg:flex  ml-0 w-full mb-10 lg:mb-0">
            ...
            <div className="lg:w-[290px] w-full mb-10 lg:mb-0 mt-16 lg:mt-0">
              {firstCol && (
                <>
                  <div className="mb-5">
            ...
            <div className="lg:w-[290px] hidden xl:flex xl:flex-col w-full mb-10 lg:mb-0 relative">
              <div>
                {secondCol && (
                  <>
                    <div className="mb-5">
