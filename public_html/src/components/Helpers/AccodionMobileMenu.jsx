  ...
  return (
    ...
    >
      <button
        onClick={handler}
        type="button"
        className="w-full bg-qpurplelow h-[50px] text-qblack flex justify-between items-center px-5"
      >
        <Link
          href={{
                ...
                {des.map((subItem) => (
                  <li key={subItem.id} className="category-item">
                    <button
                      onClick={subhandler}
                      type="button"
                      className="w-full bg-white h-[50px] text-qblack flex justify-between items-center px-5"
                    >
                      <Link
                        href={{
