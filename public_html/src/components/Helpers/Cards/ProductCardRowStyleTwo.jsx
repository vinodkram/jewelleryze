    ...
    <>
      ...
      >
        <a rel="noopener noreferrer">
          ...
          >
            <div className="w-full h-[105px] bg-white">
              <div className="w-full h-full ">
                <div className="w-full h-[205px] relative transition-all duration-300 ease-in-out ">
                  <Image
                    layout="fill"
                    objectFit="cover"
                    src={`${datas.image}`}
                    alt=""
                    className="w-full h-full hover:scale-110 transition duration-500 cursor-pointer object-cover"
                  />
                </div>
                <div className="flex-1 h-full flex flex-col justify-center px-5">
