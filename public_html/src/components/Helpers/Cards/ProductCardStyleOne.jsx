...
export default function ProductCardStyleOne({ datas }) {
  ...
  //console.log(datas);
  const itemQty = datas && datas.qty > 0 ;
      ...
      if (varients) {
        ...
        apiRequest
          ...
          .catch((err) => {
            ...
            toast.error(
              <Redirect
                message={langCntnt && langCntnt.error}
              />,
              {
                autoClose: 5000,
              }
      ...
      <div className="flex flex-col h-full justify-between">
        <div>
          <div className="product-card-img w-full h-[313px]">
            <div className="w-full h-full relative  flex justify-center items-center transition-all duration-300 ease-in-out transform group-hover:scale-110 scale-100">
              <Image
                layout="fill"
                objectFit="cover"
          ...
          <div className="product-card-details relative pt-5 px-[30px]">
			...
			<span className="text-base font-semibold float-right"> ( {datas.qty} ) Avl.</span>
            ...
            <p className="price text-start">
              ...
              {offerPrice && (
                <span
                  suppressHydrationWarning
                  className="offer-price text-qpurple font-500 text-[16px]"
                >
                  <CheckProductIsExistsInFlashSale
                    id={datas.id}
                    price={offerPrice}
        ...
        <div className="">
          ...
          { !itemQty && (
            <div
              style={{ borderRadius: "40px 0px 0" ,background: "orange" }}
              className="w-[135px] h-[48px] pl-6 pt-3 cursor-pointer  bg-qpurplelow group-hover:bg-qpurple transition-all duration-300 absolute -bottom-1 -right-1 ease-in-out" >
              <div className="w-full h-full space-x-3 text-white group-hover:text-white">
          ...
          <Link
            ...
            <div
              style={{ borderRadius: "40px 0px 0" }}
              className="w-[170px] h-[48px] pl-6 pt-3 cursor-pointer  bg-qpurplelow group-hover:bg-qpurple transition-all duration-300 absolute -bottom-1 -right-1 ease-in-out" >
              <div className="w-full h-full space-x-3 text-qpurple group-hover:text-white">
                <span className="text-base font-semibold">Select Option &nbsp;</span>
              </div>
            </div>
          </Link>
          )}
