  ...
  return (
    <div data-aos="fade-up" className={`w-full ${className || ""}`}>
      <div className="container-x mx-auto">
        ...
        <div className="grid lg:grid-cols-6 sm:grid-cols-4 grid-cols-2 rounded border-qpurplelow border overflow-hidden">
          <DataIteration
            datas={brands}
            startLength={0}
          ...
          >
            {({ datas }) => (
              <div key={datas.id} className="item">
                ...
                >
                  <div className=" border border-qpurplelow w-full h-[130px] group   transition duration-300 ease-in-out bg-white flex justify-center items-center relative cursor-pointer">
