  ...
  return (
    <>
      <Layout childrenClasses="pt-0">
        ...
        <div className="md:py-[60px] mb-[30px] py-[30px] bg-[#F9EDF7]">
          {homepage && (
            <SectionStyleThree
              products={
        ...
        {homepage && (homepage.flashSale.length > 0) && (
          <CampaignCountDown
