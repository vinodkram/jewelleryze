                            ...
                            >
                              <a rel="noopener noreferrer">
                                <div className="w-[116px] h-[40px] cursor-pointer ">
                                  <div className="transition-common bg-qpurple hover:bg-qpurplelow hover:text-qpurple border border-transparent hover:border-qpurple text-white w-full h-full flex justify-center rounded">
