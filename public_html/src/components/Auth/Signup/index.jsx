      ...
      <div className="login-page-wrapper w-full h-[1055px] lg:h-[895px] sm:h-[896px] relative">
        ...
        <div className="container-x mx-auto">
          <div className="lg:flex justify-center items-center relative w-full lg:min-h-[700px]  py-[60px]">
            {verify ? (
              <div className="lg:w-[572px] w-full lg:h-[700px] bg-white flex flex-col justify-center sm:p-10 p-5 border border-qpurplelow rounded-lg relative z-20">
                <VerifyWidget />
              </div>
            ) : signupView ? (
              <div className="lg:w-[572px] w-full lg:h-auto bg-white flex flex-col justify-center sm:p-10 p-5 border border-qpurplelow rounded-lg relative z-20">
                <SignupWidget />
              </div>
            ) : (
              ""
