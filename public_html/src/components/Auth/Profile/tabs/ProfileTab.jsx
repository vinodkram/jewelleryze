...
export default function ProfileTab({ profileInfo, updatedProfile }) {
  ...
  // profileInfo.personInfo.phone value set to blank by abhishek 
  ...
  const [country, setCountry] = useState(profileInfo.personInfo.country_id);
  const [stateDropdown, setStateDropdown] = useState(null);
  const [state, setState] = useState(profileInfo.personInfo.state_id);
  const [cityDropdown, setCityDropdown] = useState(null);
  const [city, setcity] = useState(null);
  const [city_name, setCityName] = useState(profileInfo.personInfo.city_name);
  const [address, setAddress] = useState(profileInfo.personInfo.address);
  const [zip_code, setZipCode] = useState(profileInfo.personInfo.zip_code);
  ...
  const updateProfile = async (handler) => {
    if (auth()) {
      ...
      formData.append("phone", phone.replace(/\D/g, '').slice(-10));
        ...
        setPhone(() => {
          if (
            ...
            profileInfo.personInfo.phone !== "null"
			   ...
			   // profileInfo.personInfo.phone value set to blank by abhishek 
            var myStr = profileInfo.personInfo.phone;
            var myStr1 = myStr.replace(/\D/g, '').slice(-10);
            return myStr1;
          } else {
            return null;
          }
            ...
            <div className="lg:w-[660px] ">
              ...
              <div className="input-item md:flex md:space-x-2.5 rtl:space-x-reverse mb-8">
                ...
                <div className="md:w-1/2 w-full h-full relative">
                  ...
                  <InputCom
                    ...
                    type="text" 
                    inputClasses="h-[50px] placeholder:capitalize"
                    value={phone ? phone : ""}
              ...
              <div className=" mb-6">
                <div className="w-full">
                  <InputCom
                    ...
                    placeholder={langCntnt && langCntnt.City}
                    inputClasses="w-full h-[50px]"
                    error={!!(errors && Object.hasOwn(errors, "city_name"))}
                  />
              ...
              <div className="input-item mb-8">
                <InputCom
                  ...
                  inputClasses="h-[50px]"
                  value={zip_code}
                  inputHandler={(e) => setZipCode(e.target.value)}
