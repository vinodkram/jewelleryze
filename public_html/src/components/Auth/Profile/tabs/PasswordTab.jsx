      ...
      <div className="w-full flex lg:flex-row space-x-5 lg:items-center">
        <div className="lg:w-[397px] w-full mb-10">
          <div className="input-field mb-6">
            ...
            <div className="input-wrapper border border-qpurplelow rounded w-full  h-[58px] overflow-hidden relative ">
              <input
                placeholder="******"
            ...
            <div className="sm:flex sm:space-x-[30px] items-center">
              <div className="w-[180px] h-[50px] lg:mb-0 mb-5">
                <button
                  ...
                  type="button"
                  className="transition-common bg-qpurple hover:bg-qpurplelow border border-transparent hover:border-qpurple hover:text-qpurple text-white h-full w-full  rounded "
                >
