        ...
        .then(async (res) => {
          if (res.data) {
            ...
            if (res.data.address) {
              ...
              setCityName(res.data.address.city_name);
              if (
              ...
              <div className=" mb-6">
                <div className="w-full">
                  <InputCom
                    ...
                    placeholder={langCntnt && langCntnt.your_pincode_here}
                    inputClasses="w-full h-[50px]"
                    error={!!(errors && Object.hasOwn(errors, "pincode"))}
                  />
                ...
                <div className="mt-5">
                  <table>
                    <tbody>
                      ...
                      <tr className="flex mb-3">
                        <td className="text-base text-qgray w-[70px] block line-clamp-1 capitalize">
                          <p>{langCntnt && langCntnt.Pincode}:</p>
                        </td>
                        <td className="text-base text-qblack line-clamp-1 font-medium">
                          {item.pincode}
                        </td>
