  ...
  return (
    <Layout childrenClasses="pt-0 pb-0">
      <div className="about-page-wrapper w-full">
              ...
              <div className="content lg:w-1/2 w-full">
                ...
                <Link href="/contact" passHref>
                  <a rel="noopener noreferrer">
                    <div className="w-[160px] h-[54px] transition-common bg-qpurple hover:bg-qpurplelow border border-transparent hover:border-qpurple hover:text-qpurple text-white mt-10 cursor-pointer rounded-full flex justify-center items-center">
        ...
        <div className="how-we-work-section w-full py-[60px] bg-[#F9EDF7]">
          <div className="container-x mx-auto">
              ...
              <div className="lg:flex-row flex flex-col space-y-[30px] lg:space-y-0 lg:justify-evenly w-full items-center">
                {hww.map((item, i) => (
                  <>
                    ...
                    <div className="separator w-[1px] lg:block hidden h-[197px] bg-qpurplelow"></div>
                  </>
                ))}
              </div>
            </div>
        ...
        <div className="customer-feedback w-full bg-[#F9EDF7] py-[60px]">
