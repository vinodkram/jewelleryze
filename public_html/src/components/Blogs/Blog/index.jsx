            ...
            <div className="blog-article lg:flex lg:space-x-[30px] pb-7 ">
              ...
              <div className="lg:w-[370px] w-full">
                ...
                >
                  ...
                  <div className="w-full h-[1px] bg-qpurplelow mb-5"></div>
                  <div className="w-full h-[60px] rounded overflow-hidden relative">
                    <input
                      ...
                      type="text"
                      placeholder="Search"
                      className="w-full h-full bg-qpurplelow focus:outline-none focus:ring-0 pl-5 pr-16 placeholder:text-qgray"
                    />
