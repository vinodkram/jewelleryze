            ...
            <div className="bg-white lg:p-10 p-3 rounded-xl">
              {resData && (
                <div id="printSection">
                  <div className="sm:flex justify-between items-center mb-5">
                    <div>
                      ...
                      <ul className="flex flex-col space-y-2">
                        ...
                        <li className="text-[22px]n text-qgray">
                          <strong>{langCntnt && langCntnt.Billing_Address}:{" "}</strong>
                          {resData.order_address.billing_name && (
                            <span
                              className="text-qpurple flex"
                            >
                              {resData.order_address && resData.order_address.billing_name}
                            </span>
                          )}
                          {resData.order_address.billing_email && (
                            <span
                              className="text-qpurple flex"
                            >
                              {resData.order_address && resData.order_address.billing_email}
                            </span>
                          )}
                          {resData.order_address.billing_phone && (
                            <span
                              className="text-qpurple flex"
                            >
                              {resData.order_address && resData.order_address.billing_phone}
                            </span>
                          )}
                          {resData.order_address.billing_zipcode && (
                            <span
                              className="text-qpurple flex"
                            >
                              {langCntnt && langCntnt.PincodeLabel} : {resData.order_address && resData.order_address.billing_zipcode}
                            </span>
                          )}
                          <span className="text-qpurple">{langCntnt && langCntnt.Address} : </span>
                          <span className="text-qpurple">{`${
                            resData.order_address &&
                        ...
                        <li className="text-[22px]n text-qgray">
                          <strong>{langCntnt && langCntnt.Shipping_Address}:{" "}</strong>
                          {resData.order_address.shipping_name && (
                            <span
                              className="text-qpurple flex"
                            >
                              {resData.order_address && resData.order_address.shipping_name}
                            </span>
                          )}
                          {resData.order_address.shipping_email && (
                            <span
                              className="text-qpurple flex"
                            >
                              {resData.order_address && resData.order_address.shipping_email}
                            </span>
                          )}
                          {resData.order_address.shipping_phone && (
                            <span
                              className="text-qpurple flex"
                            >
                              {resData.order_address && resData.order_address.shipping_phone}
                            </span>
                          )}
                          {resData.order_address.shipping_zipcode && (
                            <span
                              className="text-qpurple flex"
                            >
                              {langCntnt && langCntnt.PincodeLabel} : {resData.order_address && resData.order_address.shipping_zipcode}
                            </span>
                          )}
                          <span className="text-qpurple">{langCntnt && langCntnt.Address} : {`${
                            resData.order_address &&
                    ...
                    <table className="w-full text-sm text-left text-qgray dark:text-gray-400">
                      <tbody>
                        ...
                        <tr className="text-[13px] font-medium text-qblack bg-[#F6F6F6] whitespace-nowrap px-2 border-b border-qpurplelow uppercase">
                          <td className=" py-4 pl-5 block whitespace-nowrap  w-[380px]">
                          ...
                          <td className="py-4 hide-m whitespace-nowrap text-center print:hidden">
                        ...
                        {resData.order_products.length > 0 &&
                          resData.order_products.map((item, i) => (
                            ...
                            >
                                ...
                                <div className="flex space-x-6 items-center">
                                  <div className="flex-1 flex flex-col">
                                    {item.product.length > 0 &&
                                      item.product.map((itemd, i) => (
                                        <Link
                                          key={i}
                                          href={{
                                            pathname: "/products/[slug]",
                                            query: { slug: itemd.slug },
                                          }}
                                        >
                                     ...
                                     {item.order_product_variants.length > 0 &&
                                      item.order_product_variants.map((variant, i) => (
                              ...
                              <td className="text-center py-4 px-2 hide-m print:hidden">
                                <button
                                  onClick={() =>
                              ...
                              <div className="product-view w-full hide-xl justify-between h-full ">
                                ...
                                <div className="flex-1">
                                  <div className="product-details w-full mt-1 lg:mt-0">
                                    ...
                                    <td className="text-center w-1/4 py-4 ">
                                      <div className="flex space-x-1 items-center justify-center">
                                        <span className="text-[15px] font-medium text-qblack">
                                          <span>{currency_icon}</span>
                                          <span>
                                    ...
                                    <td className="text-left w-1/4 py-4 px-2 print:hidden">
                                      <button
                                        onClick={() =>
                                          reviewModalHandler(item.product_id)
                                        }
                                        type="button"
                                        className="text-qpurple text-[12px] font-semibold capitalize"
                                      >
                                        {langCntnt && langCntnt.review}
                                      </button>
                                    </td>
                        ...
                        <p className="text-sm text-qblack">
                          ...
                          <span>
                            {(parseFloat(resData.total_amount) -
                              ...
                              parseFloat(resData.gst_cost) +
                              parseFloat(resData.coupon_coast)).toFixed(2)}
                          </span>
				  ...
				  <span className="text-center pt-2">All Exchanges are applicable within 3 days of Order. For more information visit <b><a href="https://festivjewellery.com/pages/refund-policy">Exchange & Return Policy</a></b></span>
                </div>
              )}
